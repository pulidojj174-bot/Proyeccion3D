...
export class ServiceTemplate implements OnInit {
  ...
  servicesData = signal<ServiceData[]>([
    ...
    },
    {
      ...
      features: [
        'Proceso:',
        '   Levantamiento en sitio con estación total(±2 mm de precisión).',
    ...
    },
    {
      ...
      description: 'Captura de datos tridimensionales de gran escala mediante drones equipados con sensores y cámaras de alta resolución. Ideal para terrenos, estructuras y plantas industriales.',
      icon: 'bi-airplane',
      ...
      features: [
        'Tecnología:',
        '  Drones con sensores y fotogrametría de alta resolución.',
        ...
        'Aplicaciones:',
        '   Levantamiento topográfico de terrenos y zonas de difícil acceso.',
